...
import erc_run3 from "../assets/CESS/erc_run/3.jpg";
import erc_run4 from "../assets/CESS/erc_run/4.jpg";
import erc_run6 from "../assets/CESS/erc_run/6.jpg";

// interaction_and_career: iac
import iac1 from "../assets/CESS/Interaction_and_career_counseling/1.jpg";
import iac2 from "../assets/CESS/Interaction_and_career_counseling/2.jpg";
import iac3 from "../assets/CESS/Interaction_and_career_counseling/3.jpg";
import iac4 from "../assets/CESS/Interaction_and_career_counseling/4.jpg";
import iac5 from "../assets/CESS/Interaction_and_career_counseling/5.jpg";
import iac6 from "../assets/CESS/Interaction_and_career_counseling/6.jpg";

// photography_competition: pc
import pc1 from "../assets/CESS/Photography_Competition/1.jpg";
import pc2 from "../assets/CESS/Photography_Competition/2.jpg";
import pc3 from "../assets/CESS/Photography_Competition/3.jpg";
import pc6 from "../assets/CESS/Photography_Competition/6.jpg";

// relay_race: rr
import rr1 from "../assets/CESS/Relay_Race/1.jpg";
import rr2 from "../assets/CESS/Relay_Race/2.jpg";
...
export const events_data = [
  {
    sn: 0,
    theme_pic: erc_run6,
    headline: "ERC RUN 5KM, organized by FSU (Boys and Girls)",
    bit_detail:
      "Marathon Run include around 300 + participants including both boys and girls in a track. Defeating 300+ Participants Civilians won the title of both boys and girls...",
    in_depth: (
      <>
        <p>
          ERC Marathon 5 KM was organized by Free Students' Union (FSU) IOE
          Purwanchal Campus on 14th Poush 2080 including a road track with the
          station i.College Four Light ii.Bargachi iii. Shyam Chowk iv. Mahadev
          Chowk v.College Back gate to Four light with a distance of 5KM and
          open for all the staffs and students of different faculty of
          Purwanchal Campus. <br /> Marathon Run include around 300 +
          participants including both boys and girls in a track. Defeating 300+
          Participants Civilians won the title of both boys and girls.{" "}
        </p>
        <br />
        <p style={{ color: "blue" }}>Civilian Winners Boys</p>
        <p style={{ fontWeight: "600" }}>
          {" "}
          Winner: Neerajan Basnet (CESS President) (076 BCE){" "}
        </p>
        <p style={{ fontWeight: "500" }}>
          {" "}
          Runner Up: Kashiram Syanjal (078 BCE){" "}
        </p>
        <br />
        <p style={{ color: "blue" }}> Civilian Winner Girl </p>
        <p style={{ fontWeight: "600" }}>Winner: Ningwa Mabuhang (078 BCE)</p>
      </>
    ),
    images: [erc_run1, erc_run2, erc_run3, erc_run4, erc_run6],
  },
  {
    sn: 1,
    theme_pic: iac6,
    ...
    in_depth: (
      <>
        <p>
          Interaction and Career Counselling program was provided to empower
          individuals at every stage of their career, this program offered
          personalized guidance and valuable insights to help the students
          navigate the complex world of work and professional development.{" "}
          <br />
          CESS 19th Committee successfully completed its 1st event Interaction
          and Career Counselling Program on 15th Asar 2080. Through interactive
          sessions and one-on-one consultations, our experienced counselors
          provided holistic support tailored to our unique goals and aspirations
          of emerging Civil Engineers.{" "}
        </p>
        <p>
          In the program we have an experienced expertise speakers in the field
          of Civil Engineering.
        </p>
        <br /> <br />
        <p>Speakers </p>
        <p>
          1. Er. Pramod Rai (Structural Engineer) <br />
          Kamero Consultancy, Itahari{" "}
        </p>
        <p>
          2. Er. Safal Bhattarai (Senior Civil Engineer) <br />
          Dharan Sub-Metropolitan City, Gov. of Nepal{" "}
        </p>
        <p>
          3. Er. Paribesh Phuyal (Gazetted Third Class Engineer) <br />
          Government of Nepal{" "}
        </p>
        <p>
          4. Er. Kaji Ram Karki <br />
          Campus Chief, IOE Purwancal Campus{" "}
        </p>
        <p>
          5. Er. Bhisan Bhujel <br />
          Head of Department, Civil Faculty Purwancal Campus{" "}
        </p>
        <p>
          6. Er. Pravat Pratap Dev <br />
          Teacher, IOE Purwancal Campus{" "}
        </p>
      </>
    ),
    images: [iac1, iac2, iac3, iac4, iac5, iac6],
  },
  {
    sn: 2,
    theme_pic: pc6,
    ...
    in_depth: (
      <>
        <p>
          Capturing the Beauty of Civil Engineering World through the lens and
          showcasing the talent in our photography competition was the motto of
          the event. CESS 19th Committee successfully completed its 2nd event
          Beauty of Civil Engineering Photography Competition on 23rd Asar 2080.
          <br />
          Photography Competition have altogether 54 Contestant from various
          faculty of Purwanchal Campus and from various school and colleges. It
          was open competition for all the students with winner and runner up
          from judging panel and public choice award.
          <br />
          In judging panel of the competition “Beauty of Civil Engineering” we
          had the photographers with expertise of civil engineering wonders.{" "}
        </p>
        <br />
        <h4 style={{ fontWeight: "600" }}>Judge</h4>
        <p>1. Er. Summar Kunwar </p>
        <p>2. Er. Bishal Pandey </p>
        <br />
        <p>
          Various titles on capturing the true essence of the 'Beauty of Civil
          Engineering Projects' was honored to{" "}
        </p>
        <p style={{ fontWeight: "600" }}>Winners </p>
        <p>
          Winner:{" "}
          <span style={{ fontWeight: "500", color: "blue" }}>
            Pranav Gautam (Contestant No. 21)
          </span>
        </p>
        <p>
          Runner Up:{" "}
          <span style={{ fontWeight: "500", color: "blue" }}>
            Samit Thapa (Contestant No. 30)
          </span>{" "}
        </p>
        <p>
          Public Choice Award:{" "}
          <span style={{ fontWeight: "500", color: "blue" }}>
            Sagar Bashyal (Contestant No. 13)
          </span>{" "}
        </p>
      </>
    ),
    images: [pc1, pc2, pc3, pc6],
  },
  {
    sn: 3,
    theme_pic: rr6,
    headline: "NTBNS - Relay Race 200*4",
    bit_detail:
      "It was interfaculty competition with a total 16 groups, 9 groups of boys and 7 groups of girls from different faculty. Defeating 8 ....",
    in_depth: (
      <>
        <p>
          "NTBNS- Relay Race 200*4 " was organized by Nepal Terai Bidhyarthi
          Navajagran Sang (NTBNS), IOE Purwanchal Campus on 20th Magh 2080 in a
          college ground with well managed Relay track. <br />
          It was interfaculty competition with a total 16 groups, 9 groups of
          boys and 7 groups of girls from different faculty. Defeating 8 others
          group Civil Boys secured the 1st position and defeating other 6 group
          Civil Girls secured 1st position.{" "}
        </p>
        <br />
        <p style={{ fontWeight: "600" }}>Winner Boys </p>
        <p style={{ color: "blue" }}>
          1. Neerajan Basnet *Captain CESS President (076 BCE){" "}
        </p>
        <p style={{ color: "blue" }}>2. Kashiram Syanjal (078 BCE) </p>
        <p style={{ color: "blue" }}>3. Ajit Atal (078 BCE) </p>
        <p style={{ color: "blue" }}>4. Kiran Awasthi (079 BCE) </p>
        <br />

        <p style={{ fontWeight: "600" }}>Winner Girls </p>
        <p style={{ color: "blue" }}>1. Manisha Karki (076 BCE) *Captain </p>
        <p style={{ color: "blue" }}>2. Mamata Gyawali (077 BCE) </p>
        <p style={{ color: "blue" }}>3. Ningwa Mabuhang (078 BCE) </p>
        <p style={{ color: "blue" }}>4. Sweta Adhikari (079 BCE)" </p>
      </>
    ),
    images: [rr1, rr2, rr3, rr4, rr6],
  },
  {
    sn: 4,
    theme_pic: fsu1,
